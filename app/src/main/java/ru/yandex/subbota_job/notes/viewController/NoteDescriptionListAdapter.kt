...
interface ItemClickListener{
	fun itemTapUp(holder: RecyclerView.ViewHolder) : Boolean
	fun itemLongPress(holder: RecyclerView.ViewHolder) : Boolean
}
typealias OnChanged = (dragMode:Boolean)->Unit

class NoteDescriptionListAdapter(var activity : FragmentActivity, val itemClickListener: ItemClickListener, val dragModeListener: OnChanged): RecyclerView.Adapter<NoteDescriptionListAdapter.ViewHolder>(), DragAndMove{
	...
	override fun beginDrag(holder: RecyclerView.ViewHolder) {
	...
	class ViewHolder(private val adapter: DragAndMove, private val clickListener: ItemClickListener, itemView: View) : RecyclerView.ViewHolder(itemView) {
		...
		init{
			...
			dragHandle.setOnTouchListener(View.OnTouchListener { v, event ->
